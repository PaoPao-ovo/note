...
![[后端/Java基础/Java基础语法/asset/1.png]]

第二步：点击高级系统设置。

![[后端/Java基础/Java基础语法/asset/2.png]]


第三步：选择高级，再点击下面的环境变量。

 ![[后端/Java基础/Java基础语法/asset/3.png]]



第四步：找系统变量里面的PATH

 ![[后端/Java基础/day01-Java基础语法01/asset/4.png]]
...
![[image-20210923091710450.png]]

②**Path**：告诉操作系统JDK提供的javac(编译)、java(执行)命令安装到了哪个位置

![[image-20210923091721035.png]]
